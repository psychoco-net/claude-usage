...
表示例:
<img width="965" height="855" alt="claude-usage-widget02 png" src="https://github.com/user-attachments/assets/60cb9f4e-c039-452c-981a-c86021200976" />
...
* 個人利用を目的としたスクリプトです。
* 本ソフトウェアを使用して発生したいかなる損害についても、当方は一切の責任を負いかねます。
